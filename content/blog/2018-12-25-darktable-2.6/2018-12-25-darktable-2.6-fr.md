...
Suivant la tradition, darktable 2.6 sort pour Noël. 2018 a été une année de renouveau pour darktable, avec avec de nombreuses fonctionnalités majeures délivrées par de récent contributeurs.

Parmi les principales nouveautés :

* Un nouveau module _retouche_, similaire au module de _correction de tâches_, avec copie intelligente (_outil de correction_) et la possibilité d'agir sur chaque niveau de détails individuellement.

* Un nouveau module _filmique_, capable de gérer la plupart des aspects de tonalité d'une image en un seul module.

* Une refonte complète du module de _balance des couleurs_, qui peut être vu comme une variante plus orienté couleurs que le module _niveaux_, permettant la plupart des ajustements automatiquement grâce à de nouvelles options de sélection de couleurs.
...
Quelque adoucissement du masque sera en général nécessaire pour éviter les bords abrupts ou halos.
...
![Image originelle](https://raw.githubusercontent.com/darktable-org/dtorg/8d648990980a056872fb7dd74d7bec748b4f831a/content/blog/2018-12-25-darktable-2.6/cb-active-modules.jpg)
...
![Module pipette](https://raw.githubusercontent.com/darktable-org/dtorg/8d648990980a056872fb7dd74d7bec748b4f831a/content/blog/2018-12-25-darktable-2.6/cb-patches-original.png)
...
![Optimisation automatique via le module balance couleur](https://raw.githubusercontent.com/darktable-org/dtorg/8d648990980a056872fb7dd74d7bec748b4f831a/content/blog/2018-12-25-darktable-2.6/cb-picker-neutralize.jpg)
...
* Les _filtres de collection_ de la _table lumineuse_ ont désormais 3 modes permettant d'interagir avec les tags hiérarchiques. Lorsque vous sélectionnez un tag qui n'est pas un nœud (c'est-à-dire un tag avec des sous-étiquettes), donc le tag « parent » :
  * Un `clic` sélectionne seulement les images marquées uniquement avec ce tag. La recherche est définie sur le « parent ».
  * Un `contrôle`-`clic` sélectionne seulement les enfants, c'est-à-dire les images taguées avec « parent|enfant » et pas seulement « parent ». La recherche est définie sur « parent|% », où « % » signifie « toute chaîne ».
  * Un `Majuscule`+`clic` sélectionne les images marquées avec le tag lui-même ou l'un de ses enfants. La chaîne de recherche est définie sur « parent% ».
...
![Bateau débruité avec moins de réduction sur la fréquence la plus fine](https://raw.githubusercontent.com/moy/dtorg/27e2db03af22d334d9a529081180ab25af3224f6/content/blog/2018-12-25-darktable-2.6/wavelets_details.png)
...
De plus, de nouveaux préréglages sont maintenant disponibles pour le module _réduction du bruit (profil)_ qui exploite cette courbe :
...
![Débruitage du canal rouge](https://raw.githubusercontent.com/moy/dtorg/27e2db03af22d334d9a529081180ab25af3224f6/content/blog/2018-12-25-darktable-2.6/wavelets_red.png)

Une fois que les canaux RGB ont été supprimés, vous pouvez utiliser une autre instance en mode de fusion des couleurs pour éliminer les problèmes de couleur restants.

Notez que le débruitage des canaux RGB individuellement doit être effectué _avant_ d'utiliser une instance en mode de fusion des couleurs, car cela mélangera les canaux et modifiera les caractéristiques du bruit.

Ces explications étaient toutes via l'utilisation du module _réduction du bruit (profil)_ comme exemple, mais vous pouvez suivre les mêmes étapes avec le module _réduction du bruit RAW_.
Notez également que l'extrémité des canaux RGB débruités séparément, lors de la visualisation des canaux à l'aide du mélangeur de canaux, est également utile pour définir les paramètres du module _réduction du bruit (bilatéral)_.
...
![Image pâle après utilisation du module correction du profil d'entrée](https://raw.githubusercontent.com/darktable-org/dtorg/13bfb297e6364764110daba34d9080347b581733/content/blog/2018-12-25-darktable-2.6/unbreak-fade.jpg)
...
![Image vive après utilisation du module balance couleur](https://raw.githubusercontent.com/darktable-org/dtorg/13bfb297e6364764110daba34d9080347b581733/content/blog/2018-12-25-darktable-2.6/unbreak-colorbalanced.jpg)
...
![Renommer une instance](http://matthieu-moy.fr/tmp/2018/wip-dt/blog/2018-12-25-darktable-2.6/rename.png)
...
![Créer une instance pour un pré-réglage](https://raw.githubusercontent.com/darktable-org/dtorg/e6f8c41ffa4f40fd5c9d9e84e9f9221adc656506/content/blog/2018-12-25-darktable-2.6/second-instance.png)
...
![Échelle log-log sur la courbe de tonalités](https://raw.githubusercontent.com/moy/dtorg/master/content/blog/2018-12-25-darktable-2.6/tone-curve-loglog.png)
